                                            ...
                                            if (LM_Data.KYC_Status === "FETCH_FAIL") {
                                                ...
                                                let createReqObj = {
                                                    ...
                                                    "Proposal_Request": {
                                                        ...
                                                        "pan": kyc_fetch_response.data && kyc_fetch_response['data']['pan'] || "",
                                                ...
                                                //     "Search_Type": ObjRequest['Search_Type'] || "", 
                                                //     "Document_Type": ObjRequest['Document_Type'] || "", 
                                                //     "Document_ID": kyc_fetch_response['data']['pan'] || "",  
                                                //     "DOB": kyc_fetch_response['data']['dob'] || "", 
                                                //     "insurer_id": ObjRequest['Insurer_Id'] || "",  
                                                //     "crn": ObjRequest['PB_CRN'] || "", 
                                                //     "status": kyc_fetch_response['data']['status'] || "",
                                                //     "txn_id": kyc_fetch_response['data']['txn_id'] || "",
                                                //     "Proposal_Request":ObjRequest['Proposal_Request'],
                                                //     "Quote_Id": ObjRequest['Quote_Id'] || "",
                                                // };
                                                console.log('req', createReqObj);
                                                let args = {
                                                    data: createReqObj,
                                                    'headers': {
                                                        "Content-Type": "application/json"
                                                ...
                                                //                                             kyc_fetch_response={"success": false,
                                                // "message": "No record found for given PAN number"};
                                                if (kyc_fetch_response.data && kyc_fetch_response.data.status && kyc_fetch_response.data.status === "rejected") {
                                                    client.post(create_url, args, function (KYC_create_data, response) {
                                                        if (KYC_create_data.hasOwnProperty("Status") && KYC_create_data['Status'] === "CREATE_SUCCESS") {
                                                            console.log("KYC created successfully", KYC_create_data);
                                                            kyc_id = (KYC_create_data.Msg.hasOwnProperty("KYC_Number")) ? KYC_create_data.Msg.KYC_Number : "";
                                                            LM_Data.KYC_Number = kyc_id;
                                                            LM_Data.KYC_FullName = (KYC_create_data.Msg.hasOwnProperty("KYC_FullName")) ? KYC_create_data.Msg.KYC_FullName : user_name;
                                                            LM_Data.KYC_Ref_No = 'HEGI_' + timestamp;
                                                            LM_Data.KYC_Status = "CREATE_SUCCESS";
                                                        } else {
                                                            LM_Data.KYC_Status = "CREATE_FAIL";
                                                            if (KYC_create_data.data && KYC_create_data.data.rejectionReason) {
                                                                LM_Data.Error_Msg = KYC_create_data.data.rejectionReason;
                                                            } else if (KYC_create_data.message) {
                                                                LM_Data.Error_Msg = KYC_create_data.message;
                                                            }
                                                        }
                                                        saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                                                        res.json({ "Insurer": "HDFC", "Msg": LM_Data, "Status": LM_Data.KYC_Status });
                                        ...
                                        if (data) {
                                            ...
                                            if (data.hasOwnProperty("message") && data.message !== "") {
                                                ...
                                                if (data.hasOwnProperty("success") && data.success === true && data.hasOwnProperty("data") && data.data.hasOwnProperty("iskycVerified")) {
                                                    ...
                                                    if (LM_Data.KYC_Status === "VERIFY_FAIL" && data.data.rejectionReason) {
                                                        LM_Data.Error_Msg = data.data.rejectionReason;
                                                    }
                                                } else {
                                                    LM_Data.KYC_Status = "VERIFY_FAIL";
                                                    LM_Data.KYC_Redirect_URL = ObjRequest.KYC_URL;
...
//                 "nationality": "Indian",
//                 "mother_name": "",
//                 "txn_id": ObjRequest.Proposal_Request['txn_id'] || ObjRequest.Quote_Id || "", //"HEGI_0009",
...
//             };
            let req_txt ={
                ...
                "mobile": "9911976238",
                "pan": "BELPP6095N",
                "permanent_address": "S/O CHHAJU RAM MOH SALAMPURA",
                "permanent_city": "NARNAUL",
                "permanent_pincode": "123001",
                "correspondence_address": "S/O CHHAJU RAM MOH SALAMPURA",
                "correspondence_city": "NARNAUL",
                "correspondence_pincode": "123001",
                "dob": "02/06/1985",
                "aadhar_uid": "1735",
                "email": "rk.nnll@gmail.com",
                "occupation": "Other",
                "organization_type": "Government",
                "is_politically_exposed": false,
                "annual_income": "0-2.5 lacs",
                "nationality": "Indian",
                "mother_name": "",
                "txn_id": "HEGI_1705464741",
                "gender": "M"
                
            }
            console.log("req_txt", req_txt);
            ObjRequest.Proposal_Request['status'] = "approved"
            if (ObjRequest.Proposal_Request['status'] !== "rejected") {
//                 req_txt["profile_image"] = (ObjRequest.Doc3 !== undefined && ObjRequest.Doc3 !== "" && ObjRequest.Doc3 !== null) ? (weburl + ObjRequest.Doc3) : "";
                req_txt["profile_image"] = "https://horizon.policyboss.com:5443//tmp/kyc_documents/7970805_544313141735_5.jpg";
...
//                         "back": (ObjRequest.Doc2 !== undefined && ObjRequest.Doc2 !== "" && ObjRequest.Doc2 !== null) ? (weburl + ObjRequest.Doc2) : ""
                        "type": "aadhaar",
                        "front": "https://horizon.policyboss.com:5443//tmp/kyc_documents/7970805_544313141735_5Front.jpg",
                        "back": "https://horizon.policyboss.com:5443//tmp/kyc_documents/7970805_544313141735_5Front.jpg"
                    }
                ]
            };
                                ...
                                if (token) {
                                    ...
                                    request(options, function (error, response) {
                                        ...
                                        if (response) {
                                            ...
                                            if (kyc_create_response && kyc_create_response.success === false && kyc_create_response.message) {
                                                LM_Data.Error_Msg = kyc_create_response.message;
                                            }
                            ...
                            if (token) {
                                ...
                                client1.post(kyc_fetch_url, args, function (data, response) {
                                    if (data) {
                                        ...
                                        if (LM_Data.KYC_Status === "FETCH_FAIL" && data.data && data.data.KYC_Remark) {
                                            LM_Data.Error_Msg = data.data.KYC_Remark;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                            ...
                            if (token) {
                                ...
                                client1.get(kyc_verify_url, args, function (data, response) {
                                    if (data) {
                                        ...
                                        if (LM_Data.KYC_Status === "VERIFY_FAIL" && data.data && data.data.KYC_Remark) {
                                            LM_Data.Error_Msg = data.data.KYC_Remark;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                                        res.json({"Insurer": "Edelweiss", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
...
//                                                LM_Data['KYC_FullName'] = (data.kycDetails.hasOwnProperty("middleName") && data.kycDetails.middleName && data.kycDetails.middleName !== "") ? (data.kycDetails.firstName + " " + data.kycDetails.middleName + " " + data.kycDetails.lastName) : (data.kycDetails.firstName + " " + data.kycDetails.lastName);
                                        ...
                                        if (LM_Data['KYC_Status'] === "FETCH_FAIL" && data.errMsg) {
                                            LM_Data['Error_Msg'] = data.errMsg;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                                ...
                                client1.post(royal_verify_service, args, function (data, response) {
                                    if (data) {
                                        ...
                                        if (data && data.hasOwnProperty("applicationStatus") && data.applicationStatus === "Success") {
                                            ...
                                            if (kyc_verify_response.errMessage) {
                                                LM_Data["Error_Msg"] = kyc_verify_response.errMessage;
                                            }
                                        }
                                        if (LM_Data['KYC_Redirect_URL']) {
                                            LM_Data['ckyc_remarks'] = "NA";
                        ...
                        if (data) {
                            if (data.hasOwnProperty('message') && data.message === "Endpoint request timed out") {
                                ...
                                if (decrypted_res.hasOwnProperty("kycStatus") && decrypted_res.kycStatus === "KYC_SUCCESS" && decrypted_res.hasOwnProperty("ckycNumber") && decrypted_res["ckycNumber"]) {
                                    ...
                                    LM_Data.Error_Msg = decrypted_res.errMsg || "";
                                }
                                saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                            ...
                            try {
                                ...
                                client.post(kyc_create_url, args, function (data, response) {
                                    if (data) {
                                        ...
                                        LM_Data.KYC_Response = kyc_create_response;
                                        if (data.errMsg && LM_Data.KYC_Status === "CREATE_FAIL") {
                                            LM_Data.Error_Msg = data.errMsg;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_create_request, kyc_create_response);
                                        res.json({"Insurer": "BAJAJ", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
            ...
            try {
                ...
                client.post(kyc_fetch_url, args1, function (data, response) {
                    if (data) {
                        ...
                        if (LM_Data.KYC_Status === "VERIFY_FAIL" && decrypted_res && decrypted_res.errMsg) {
                            LM_Data.Error_Msg = decrypted_res.errMsg;
                        }
                        saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                        res.json({"Insurer": "BAJAJ", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                            ...
                            if (token) {
                                ...
                                client1.post(chola_verify_service, args, function (data, response) {
                                    if (data) {
                                        ...
                                        if (LM_Data['KYC_Status'] === "FETCH_FAIL" && data.ErrorMsg) {
                                            LM_Data.Error_Msg = data.ErrorMsg;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                            ...
                            if (token) {
                                ...
                                client1.post(chola_verify_service, args, function (data, response) {
                                    if (data) {
                                        ...
                                        if (LM_Data['KYC_Status'] === "VERIFY_FAIL" && data.Remarks) {
                                            LM_Data.Error_Msg = data.Remarks;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                                        res.json({"Insurer": "CholaMS", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                                    } else {
                                    ...
                                    if (token) {
                                        ...
                                        client1.post(future_create_service, args, function (data, response) {
                                            if (data) {
                                                ...
                                                if (LM_Data['KYC_Status'] === "VERIFY_FAIL" && data.ckyc_remarks) {
                                                    LM_Data['Error_Msg'] = data.ckyc_remarks;
                                                }
                                                saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                                    ...
                                    client1.post(future_verify_service, args, function (data, response) {
                                        if (data) {
                                            ...
                                            if (LM_Data['KYC_Status'] === "VERIFY_FAIL") {
                                                LM_Data['Error_Msg'] = data.ckyc_remarks ? (data.ckyc_remarks) : (data.message ? data.message : "");
                                            }
                                            saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                                            res.json({"Insurer": "FUTURE", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                                        } else {
                            ...
                            if (token) {
                                ...
                                client1.post(liberty_verify_service, args, function (data, response) {
                                    if (data && data.hasOwnProperty('enc_response')) {
                                        ...
                                        if (LM_Data['KYC_Status'] === "FETCH_FAIL" && data_dec.KYC_Remark) {
                                            LM_Data['Error_Msg'] = data_dec.KYC_Remark;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                            ...
                            if (token) {
                                ...
                                client1.post(liberty_verify_service, args, function (data, response) {
                                    if (data && data.hasOwnProperty('enc_response')) {
                                        ...
                                        if (LM_Data['KYC_Status'] === "VERIFY_FAIL" && data_dec.KYC_Remark) {
                                            LM_Data['Error_Msg'] = data_dec.KYC_Remark
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                                        res.json({"Insurer": "Liberty", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
        ...
        try {
            ...
            client.get(kyc_verify_url, args, function (data, response) {
                if (data) {
                    ...
                    if (LM_Data.KYC_Status === "VERIFY_FAIL" && data.message) {
                        LM_Data.Error_Msg = data.message;
                    }
                    saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                    res.json({"Insurer": "DIGIT", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
...
//                                let temp_dob = (ObjRequest.DOB === undefined || ObjRequest.DOB === "" || ObjRequest.DOB === null) ? "" : moment(ObjRequest.DOB, 'DD/MM/YYYY').format("DD-MM-YYYY");
                                ...
                                client1.post(kyc_fetch_url, args, function (data, response) {
                                    if (data) {
                                        ...
                                        if (data.message && LM_Data.KYC_Status === "FETCH_FAIL") {
                                            LM_Data.Error_Msg = data.message;
                                        }
                                        saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
            ...
            try {
                ...
                client1.post(united_fetch_service, args, function (data, response) {
                    if (data) {
                        ...
                        if (LM_Data['KYC_Status'] === "FETCH_FAIL" && data.errormessage) {
                            LM_Data['Error_Msg'] = data.errormessage;
                        }
...
//            var user_kyc_no = (ObjRequest.KYC_Number === undefined || ObjRequest.KYC_Number === "" || ObjRequest.KYC_Number === null) ? "" : ObjRequest.KYC_Number;
            ...
            try {
                ...
                client1.post(united_verify_service, args, function (data, response) {
                    if (data) {
                        ...
                        if (LM_Data['KYC_Status'] === "VERIFY_FAIL" && data.errormessage) {
                            LM_Data['Error_Msg'] = data.errormessage;
                        }
                        saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                        res.json({"Insurer": "United India", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                    ...
                    if (auth_data.hasOwnProperty('vErrorMsg') && auth_data.vErrorMsg === "Success") {
                        ...
                        client1.post(fetch_service_url, args, function (data, response) {
                            if (data) {
                                ...
                                if (LM_Data['KYC_Status'] === "FETCH_FAIL" && data.ExceptionErrorMsg) {
                                    LM_Data['Error_Msg'] = data.ExceptionErrorMsg;
                                }
                                saveKYCDetails(ObjRequest, LM_Data, kyc_fetch_request, kyc_fetch_response);
                    ...
                    if (auth_data.hasOwnProperty('vErrorMsg') && auth_data.vErrorMsg === "Success") {
                        ...
                        client.post(verify_service_url, args1, function (data, response1) {
                            if (data) {
                                ...
                                if (LM_Data['KYC_Status'] === "VERIFY_FAIL") {
                                    LM_Data['Error_Msg'] = data.ErrorMessage ? data.ErrorMessage : (data.ExceptionErrorMsg ? data.ExceptionErrorMsg : "");
                                }
                                saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                                res.json({"Insurer": "KOTAK", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                            } else {
            ...
            request(options, function (error, data) {
                try {
                    ...
                    if (data && data.statusCode === 200 || data.statusCode === '200') {
                        ...
                        LM_Data['Error_Msg'] = data.statusMessage || "";
                        saveKYCDetails(ObjRequest, LM_Data, kyc_verify_request, kyc_verify_response);
                        res.json({"Insurer": "NewIndia", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                    }
                } catch (err) {
            ...
            request(options, function (error, response) {
                ...
                if (AuthKey !== null || AuthKey !== "") {
                    ...
                    request(options, function (error, response) {
                        ...
                        if (response) {
                            kyc_create_response = response.body ? JSON.parse(response.body) : response.body;
                            if (kyc_create_response['ServiceResult'] && kyc_create_response['ServiceResult'] === "Success" && kyc_create_response['OutputResult'] && kyc_create_response['OutputResult']['KYCLogID']) {
                                kyc_id = (kyc_create_response['OutputResult'].hasOwnProperty("KYCNumber")) ? kyc_create_response['OutputResult']['KYCNumber'] : "";
                                LM_Data.KYC_Status = "CREATE_SUCCESS";
                                LM_Data.KYC_Number = kyc_id;
                                LM_Data.KYC_Ref_No = (kyc_create_response['OutputResult'].hasOwnProperty("KYCLogID")) ? kyc_create_response['OutputResult']['KYCLogID'] : "";
                                ;
                            } else {
                                LM_Data.KYC_Status = "CREATE_FAIL";
                                LM_Data.ckyc_remarks = kyc_create_response['ErrorText'] || "NA";
                            }
                            LM_Data.KYC_Response = kyc_create_response;
                            saveKYCDetails(ObjRequest, LM_Data, kyc_create_request, kyc_create_response);
                            res.json({"Insurer": "MagmaHDI", "Msg": LM_Data, "Status": LM_Data.KYC_Status});
                        ...
                        if (data) {
                            ...
                            client1.post(config.environment.weburl + '/postservicecall/sbig/decrypt', sbigDecryptObj, function (sbigDecryptData, response) {
                                if (sbigDecryptData.hasOwnProperty('decryptedData')) {
                                    ...
                                    if (LM_Data['KYC_Status'] === "VERIFY_FAIL" && kyc_fetch_response.A99ResponseData && kyc_fetch_response.A99ResponseData.CKYCSearchResult && kyc_fetch_response.A99ResponseData.CKYCSearchResult.CKYCRejectionDescription) {
    ...
    function encryptSBIG(planText) {
        var SymKeyBase64 = 'RrRaL75IL0svVZW8yiDcin3sEM4iE8eQ';
        var ivBase64 = 'rVGOux4F38k3';
