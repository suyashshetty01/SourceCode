...
//   3. Include jquery.dialogMissCallAlert.js
//   4. Call $.dialogMissCallAlert(); after document ready
//
//
// OPTIONS
//
...
//
(function ($) {
    jQuery.MisscallAlertCheck = function (options) {
        var defaults = {
        ...
        $('body').append('<div title="Miss Call Alert" id="dialogMissCallAlert-dialog" style="text-align:center; padding-top:15px;">' + o.message.replace("#seconds#", o.remainsSeconds) + '</div>');
        $('#dialogMissCallAlert-dialog').dialog({
            autoOpen: false,
            width: 400,
            modal: true,
            closeOnEscape: false,
            ...
            open: function (event, ui) {
                ...
                if (o.remainsSeconds > 0) {
                    ...
                    window.setInterval(function () {
                        _n--;
                        $("#dialogMissCallAlert-dialog").html(o.message.replace("#seconds#", _n));
                    }, 1000);
                }
            },
            buttons: {
            ...
            switch (action) {
                case 'start':
                    ...
                    dialogTimer = setTimeout(function () {
                        $('#dialogMissCallAlert-dialog').dialog('open');
