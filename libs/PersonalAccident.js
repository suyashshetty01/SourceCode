...
PersonalAccident.prototype.client_id = 0;
PersonalAccident.prototype.request_unique_id = '';
PersonalAccident.prototype.__proto__ = Base.prototype;
var mongojs = require('mongojs');
var myDb = mongojs(config.db.connection + ':27017/' + config.db.name);
PersonalAccident.prototype.const_premium_breakup = {
    "addon": {
        "addon_dsi": 0,
        "addon_uar": 0,
        "addon_ncb": 0,
...
PersonalAccident.prototype.product_api_pre = function () {
...
PersonalAccident.prototype.product_field_process_pre = function () {
...
PersonalAccident.prototype.product_response_handler = function (objResponseJson, objProduct, objInsurerProduct, Insurer_Object, specific_insurer_object) {
...
//                    "Sum_Insured": parseInt(objInsurerProduct.lm_request['pa_insurance_si']),
...
PersonalAccident.prototype.product_field_process_post = function () {

};
PersonalAccident.prototype.product_api_post = function () {

};
PersonalAccident.prototype.PersonalAccident_suminsured = function (objInsurerProduct, objProduct, Insurer_Object, specific_insurer_object) {
    var objInsurerProduct = this;
    var suminsured = objInsurerProduct.lm_request["pa_insurance_si"] - 0;
    var suminsured_next = 0;
    var suminsured_pre = 75000000;
    var suminsured_array = objInsurerProduct.const_insurer_suminsured;
    var insurer_id = Insurer_Object.Insurer_ID;
    
//    Reliance Sum Inured Logic Start
    if (insurer_id == 9) {
        let TotalCapitalSI = {'2744': 500000, '1982': 500000, '1983': 1000000, '1984': 2000000};
        let sumInsuredRange = {
            2744: [500000],
            1982: [500000],
            1983: [500000, 1000000],
            1984: [500000, 1000000, 2000000]
        };
        let annualIncomeId = '';
        let annualIncome = objInsurerProduct.lm_request['member_1_monthly_income'] * 12;
        ...
        suminsured_array = sumInsuredRange.hasOwnProperty(annualIncomeId) ? sumInsuredRange[annualIncomeId] : [500000, 1000000, 2000000];
        
    }
    else if ([1,44].includes(insurer_id-0) && this.lm_request['initial_si'] == 0) {
        let TotalCapitalSI = '';
        var closestSI;
        TotalCapitalSI = objInsurerProduct.lm_request['member_1_monthly_income'] * 120;
        if (TotalCapitalSI > 20000000) {
            closestSI = 20000000;
        } else {
//            var closestSI = suminsured_array.reduce((a, b) => {
//                return Math.abs(b - TotalCapitalSI) < Math.abs(a - TotalCapitalSI) ? b : a;
//            });
            
            closestSI = suminsured_array.reverse().find(e => e <= TotalCapitalSI);
        }
        suminsured_array = closestSI ? [closestSI] : suminsured_array;

    }
//    Reliance Sum Inured Logic End

    var si_available = objInsurerProduct.PersonalAccident_suminsured_selector(objProduct.lm_request['pa_insurance_si'] - 0, suminsured_array);

//    objProduct.insurer_lm_request['pa_insurance_si'] = si_available;
//    objInsurerProduct.product_processed_request['pa_insurance_si'] = si_available;
    objInsurerProduct.prepared_request["pa_insurance_si"] = si_available;
    objInsurerProduct.processed_request["___pa_insurance_si___"] = si_available;
    ...
    //objInsurerProduct.lm_request["pa_insurance_si"] = suminsured_next;
    //objInsurerProduct.prepared_request["pa_insurance_si"] = suminsured_next;
    //objInsurerProduct.processed_request["___pa_insurance_si___"] = suminsured_next;
    objInsurerProduct.process_execute_plan(objInsurerProduct, objProduct, Insurer_Object, specific_insurer_object);
//        objInsurerProduct.lm_request["pa_insurance_si"] = suminsured_pre;
//        objInsurerProduct.prepared_request["pa_insurance_si"] = suminsured_pre;
//        objInsurerProduct.processed_request["___pa_insurance_si___"] = suminsured_pre;
//        objInsurerProduct.process_execute_plan(objInsurerProduct, objProduct, Insurer_Object, specific_insurer_object);

    console.log(this.constructor.name, 'PersonalAccident_suminsured', 'Start', specific_insurer_object);
};
PersonalAccident.prototype.PersonalAccident_suminsured_selector = function (selected_health_si, const_insurer_suminsured) {
    var objInsurerProduct = this;
    ...
    console.log(this.constructor.name, 'PersonalAccident_suminsured_selector', 'Finish', suminsured_available);
    return suminsured_available;
};
PersonalAccident.prototype.get_const_premium_breakup = function () {
...
PersonalAccident.prototype.get_const_rate_breakup = function () {
...
PersonalAccident.prototype.policy_start_date = function () {
...
PersonalAccident.prototype.policy_end_date = function () {
...
PersonalAccident.prototype.adult_count = function () {
    ...
    if (this.lm_request.hasOwnProperty('adult_count') && this.lm_request['adult_count'] - 0 > 0) {
        ...
        adult_count++;
        if (this.lm_request['pa_insurance_type'] === 'floater' && this.lm_request.hasOwnProperty('member_2_gender') && this.lm_request['member_2_gender'] !== '') {
            adult_count++;
        }
    }
    return adult_count;
};
PersonalAccident.prototype.child_count = function () {
    ...
    } else if (this.lm_request['pa_insurance_type'] === 'floater')
    {
...
PersonalAccident.prototype.get_member_age = function (i) {
...
PersonalAccident.prototype.get_member_age_in_months = function (i) {
    console.log(this.constructor.name, 'get_member_birth_date', 'Start');
...
PersonalAccident.prototype.get_member_relation = function (i) {
...
PersonalAccident.prototype.get_member_birth_date = function (i) {
...
PersonalAccident.prototype.member_age_slab_year = function () {
...
PersonalAccident.prototype.elder_member_age = function () {
...
PersonalAccident.prototype.elder_member_age_in_months = function () {
...
PersonalAccident.prototype.randomName = function (length) {
    var result = '';
...
PersonalAccident.prototype.health_pb_crn_create_NIU = function (lm_request, client_id, request_unique_id, user_data_id) {
    try {
        var moment = require('moment');
        var crn_data = {
            "SumInsured": lm_request.hasOwnProperty("pa_insurance_si") ? lm_request['pa_insurance_si'].toString() : "0",
            "HealthType": "Topup",
            "DeductibleAmount": lm_request.hasOwnProperty("pa_insurance_si") ? lm_request['pa_insurance_si'] : 0,
            "TypeOfPolicy": "NEW",
            "CityID": lm_request.city_id,
            "PolicyTermYear": lm_request.policy_tenure,
            "PolicyFor": lm_request.pa_insurance_type === "floater" ? "Family" : "Self", //??
            "ProductID": 8,
        ...
        client.post(config.pb_config.api_health_crn_url, args, function (data, response) {
            ...
            if (is_email)
            {
                ...
                var sub = '[' + config.environment.name.toString().toUpperCase() + '-' + ((data > 0) ? 'INFO' : 'ERR') + '][PA]CRN_';
        ...
        console.error('pa_pb_crn_create', e);
    }
};
PersonalAccident.prototype.health_pb_crn_create = function (lm_request, client_id, request_unique_id, user_data_id) {
    try {
        var moment = require('moment');
        var crn_data = {
            "SumInsured": lm_request.hasOwnProperty("pa_insurance_si") ? lm_request['pa_insurance_si'].toString() : "0",
            ...
            "DeductibleAmount": lm_request.hasOwnProperty("pa_insurance_si") ? lm_request['pa_insurance_si'] : 0,
            "TypeOfPolicy": "NEW",
            "CityID": lm_request.hasOwnProperty("city_id") ? lm_request['pa_insurance_si'] : "",
            "PolicyTermYear": lm_request.policy_tenure,
            "PolicyFor": lm_request.pa_insurance_type === "floater" ? "Family" : "Self", //??
            "ProductID": 8,
            "ExistingCustomerReferenceID": (lm_request.hasOwnProperty('crn') && lm_request['crn'] !== '') ? lm_request['crn'] : 0,
...
PersonalAccident.prototype.premium_list_db = function (dbRequestItem, request_unique_id = '', client_id = 0, response_version = '1.0') {
...
PersonalAccident.prototype.premium_list_db_handler_back = function (Db_Data_Object, response_version = '1.0') {
...
PersonalAccident.prototype.premium_list_db_handler = function (Db_Data_Object, response_version = '1.0') {
    console.log('Start', 'premium_list_db_handler');
    if (Db_Data_Object.Request && Db_Data_Object.Log && Db_Data_Object.Insurer) {
        if (response_version === '1.0') {
...
PersonalAccident.prototype.premium_list_db_handler_version_1 = function (Db_Data_Object) {
    var objHealth = this;
    try {
        console.log('Start', 'premium_list_db_handler');
...
PersonalAccident.prototype.premium_list_db_handler_version_2 = function (Db_Data_Object) {
...
//        if ([9, 19, 38, 46, 44].indexOf(Db_Data_Object.Log[i]['Insurer_Id'] - 0) > -1 && Db_Data_Object.Log[i]['LM_Custom_Request']['pa_insurance_si'] < 500000 && Db_Data_Object.Request['Request_Core']['is_posp'] === 'yes') {
...
//                if ([9, 19, 38, 46, 44].indexOf(dbLogItems[k]['Insurer_Id'] - 0) > -1 && dbLogItems[k]['LM_Custom_Request']['pa_insurance_si'] < 500000 && Db_Data_Object.Request['Request_Core']['is_posp'] === 'yes') {
//                    plan_name = 'POS - ' + plan_name;
//                }
                All_Response['Insurer_' + dbLogItems[k]['Insurer_Id']]['Plan_List'][plan_len] = {
                    ...
                    "Sum_Insured": dbLogItems[k]['Premium_Breakup']['pa_insurance_si'],
                    ...
                    "Premium_Breakup": dbLogItems[k]['Premium_Breakup'],
                    "Insurer_Response": dbLogItems[k]['Premium_Response'],
                    "Benefits": dbLogItems[k]['Premium_Breakup']['benefits']
...
//                    'Plan_Addon_Premium': dbLogItems[k]['Premium_Breakup']['addon']['addon_final_premium']
    ...
    for (var k in All_Response) {
        ...
        if (!(lm_request.app_version.includes('PolicyBoss'))) {
            All_Response[k]['Plan_List'].sort(function (a, b) {
    ...
    for (var key in Final_All_Response_1) {
        for (var plankey in Final_All_Response_1[key]['Plan_List']) {
            ...
            if ([9, 19, 38, 46, 44].indexOf(Final_All_Response_1[key]['Insurer_Id'] - 0) > -1 && Final_All_Response_1[key]['Plan_List'][plankey]['Sum_Insured'] < 500000 && Db_Data_Object.Request['Request_Core']['is_posp'] === 'yes') {
                plan_name = 'POS - ' + plan_name;
            }
            ...
            list['Benefits'] = Final_All_Response_1[key]['Plan_List'][plankey]['Benefits'];
...
PersonalAccident.prototype.elder_member_birth_date = function () {
    console.log('Start', this.constructor.name, 'elder_member_age_in_months');
    var member_1_month_age = this.get_member_age_in_months(1);
    var member_2_month_age = this.get_member_age_in_months((this.lm_request.hasOwnProperty('member_2_birth_date')) ? 2 : 0);
    return member_1_month_age > member_2_month_age ? this.lm_request['member_1_birth_date'] : this.lm_request['member_2_birth_date'];
};
PersonalAccident.prototype.get_insured_relation = function (i) {
    var gender = this.lm_request['member_' + i + '_gender'];
    var rel_text = this.lm_request["relation_text"] === undefined ? this.lm_request["relation"] : this.lm_request["relation_text"];
    if (rel_text.toUpperCase().includes('MOTHER') || rel_text.toUpperCase().includes('FATHER') || rel_text.toUpperCase().includes('PARENT')) {
        return((gender === 'M' || gender === 'TM') ? 'Son' : 'Daughter');
    }
    if (rel_text.toUpperCase().includes('SON') || rel_text.toUpperCase().includes('DAUGHTER') || rel_text.toUpperCase().includes('CHILD')) {
        return((gender === 'M' || gender === 'TM') ? 'Father' : 'Mother');
    }
    if (rel_text.toUpperCase() === 'SPOUSE' || rel_text.toUpperCase() === 'WIFE' || rel_text.toUpperCase() === 'HUSBAND') {
        if (i >= 3) {
            return((gender === 'M' || gender === 'TM') ? 'Son' : 'Daughter');
        }
        return 'Spouse';
    }
    if (rel_text.toUpperCase() === 'SELF' || rel_text === '') {
        if (i >= 3) {
            return((gender === 'M' || gender === 'TM') ? 'Son' : 'Daughter');
        } else if (i === 1) {
            return 'Self';
...
module.exports = PersonalAccident;