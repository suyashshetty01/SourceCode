...
function ValidateVAD(InsName) {
    ...
    else if (InsName == "Kotak" || InsName == "MagmaHDI") {
        if (InsName == "Kotak") {
    ...
    if ($('#IsFinanced').val() == "True") {
        ...
        if (InsName == "ICICI" || InsName == "Kotak") {
    ...
    if (is_valid_pucc && is_valid_pucc == "yes" && summary.Quote_Request.vehicle_insurance_type === "renew") {
        if ($("#PUCC_No_Yes").hasClass('btn-default') && $("#PUCC_No_No").hasClass('btn-default') && $("#PUCC_valid_yn").val() == "" && (InsurerID == 4 || InsurerID == 10 )) {
            $('#dvIsPucc').addClass('Error'); ValidationArray.push('PUCC_valid_yn'); ValidateError++;
        } else {
            $('#dvIsPucc').removeClass('Error');
        }

        if ($("#PUCC_valid_yn").val() && $("#PUCC_valid_yn").val() != "" ) {
...
function set_values(request) {
    ...
    //pucc
    if (request.hasOwnProperty("is_valid_pucc") && request.is_valid_pucc == "no") {
        is_valid_pucc = "no";
        pucc_number = "";
        pucc_end_date = "";
        $("#PUCC_valid_yn").val('no');
