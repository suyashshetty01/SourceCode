...
FutureGeneraliMotor.prototype.insurer_product_field_process_pre = function () {
    ...
    try {
        ...
        this.method_content = this.method_content.replace('___dbmaster_insurer_vehicle_fueltype___', this.prepared_request['dbmaster_insurer_vehicle_fueltype']);
            ...
            if (this.lm_request['vehicle_insurance_type'] === 'new') {
                if (this.lm_request['is_pa_od'] === 'yes' && this.lm_request.hasOwnProperty('cpa_tenure') && this.lm_request['cpa_tenure'] !== null && this.lm_request['cpa_tenure'] !== '' && this.lm_request['cpa_tenure'] !== undefined) {
                    if (parseInt(this.lm_request['cpa_tenure']) > 0) {
                        ...
                        this.prepared_request['is_cpa_year'] = 1;
                        this.processed_request['___is_cpa_year___'] = 1;
                        this.method_content = this.method_content.toString().replace('___is_cpa_year___', 1);
                    }
                }
        ...
        if (this.lm_request['method_type'] === 'Proposal' || this.lm_request['method_type'] === 'Customer') {
            ...
            if (prevInsAddress.length > 30) {
                let address_1 = '', address_2 = '', address_3 = '', address_4 = '', address_5 = '';
                prevInsAddress = prevInsAddress.split(',');
                address_1 = (prevInsAddress.hasOwnProperty('0') ? (prevInsAddress[0] + ", ") : "") + (prevInsAddress.hasOwnProperty('1') ? (prevInsAddress[1] + ", ") : ""); //prevInsAddress[0] + ',' + prevInsAddress[1];
                address_2 = (prevInsAddress.hasOwnProperty('2') ? (prevInsAddress[2] + ", ") : "") + (prevInsAddress.hasOwnProperty('3') ? (prevInsAddress[3] + ", ") : ""); //prevInsAddress[2] + ',' + prevInsAddress[3];
                address_3 = (prevInsAddress.hasOwnProperty('4') ? (prevInsAddress[4] + ", ") : "") + (prevInsAddress.hasOwnProperty('5') ? (prevInsAddress[5] + ", ") : ""); //prevInsAddress[4] + ',' + prevInsAddress[5];
                address_4 = (prevInsAddress.hasOwnProperty('6') ? (prevInsAddress[6] + ", ") : "") + (prevInsAddress.hasOwnProperty('7') ? (prevInsAddress[7] + ", ") : ""); //prevInsAddress[6] + ',' + prevInsAddress[7];
                address_5 = (prevInsAddress.hasOwnProperty('8') ? (prevInsAddress[8] + ", ") : "") + (prevInsAddress.hasOwnProperty('9') ? (prevInsAddress[9] + ", ") : ""); //prevInsAddress[8] + ',' + prevInsAddress[9];
                this.prepared_request['previousinsurer_address_1'] = address_1;
                this.processed_request['___previousinsurer_address_1___'] = this.prepared_request['previousinsurer_address_1'];
                this.prepared_request['previousinsurer_address_2'] = address_2;
                this.processed_request['___previousinsurer_address_2___'] = this.prepared_request['previousinsurer_address_2'];
                this.prepared_request['previousinsurer_address_3'] = address_3;
                this.processed_request['___previousinsurer_address_3___'] = this.prepared_request['previousinsurer_address_3'];
                this.prepared_request['previousinsurer_address_4'] = address_4;
                this.processed_request['___previousinsurer_address_4___'] = this.prepared_request['previousinsurer_address_4'];
                this.prepared_request['previousinsurer_address_5'] = address_5;
        ...
        if (['Proposal'].indexOf(this.lm_request['method_type']) > -1) {
        ...
        if (['Verification'].indexOf(this.lm_request['method_type']) > -1) {
            if (this.processed_request.hasOwnProperty("___dbmaster_insurer_transaction_identifier___") && this.processed_request['___dbmaster_insurer_transaction_identifier___'] && this.processed_request['___dbmaster_insurer_transaction_identifier___'] !== "" && this.processed_request['___dbmaster_insurer_transaction_identifier___'] !== "undefined") {
                this.prepared_request['kyc_no'] = this.processed_request['___dbmaster_insurer_transaction_identifier___'].split("_")[1];
                this.processed_request['___kyc_no___'] = this.prepared_request['kyc_no'];
            } else {
                this.prepared_request['kyc_no'] = "";
                this.processed_request['___kyc_no___'] = this.prepared_request['kyc_no'];
...
//        let lm_service_url = ((config.environment.name === 'Production') ? 'http://qa-www.policyboss.com:3000/future_requests/future_services' : 'http://qa-www.policyboss.com:3000/future_requests/future_services');
//        let post_request = {
//            headers: {
...
//        };
        ...
        console.error('FutureGenerali.js Request1', post_request.data);
        console.error('FutureGenerali.js Request2', post_request);
        client.post(lm_service_url, post_request, function (future_data, future_response) {
			console.error("Future Roshani service call future_data : ",future_data);
			console.error("Future Roshani service call future_response : ",future_response);
        ...
        if (Error_Msg === 'NO_ERR') {
            ...
            if (objPremiumVerification.Status) {
                if (this.lm_request.hasOwnProperty('pay_from') && this.lm_request['pay_from'] === 'wallet') {
                    ...
                    objServiceHandler.Payment.pg_data = pg_data;
                    objServiceHandler.Payment.pg_redirect_mode = 'POST';
                    objServiceHandler.Insurer_Transaction_Identifier = 'PB' + this.lm_request['crn'] + "_" + this.lm_request['kyc_no'];
                }
            } else {
                Error_Msg = 'LM_PREMIUM_MISMATCH_' + JSON.stringify(objPremiumVerification);
            }
                ...
                if (parseInt(this.lm_request['product_id']) === 10 || parseInt(this.lm_request['product_id']) === 1) {
                    if (objResponseJson.hasOwnProperty('Root')) {
                        ...
                        if (objResponseJson['Root'].hasOwnProperty('Policy')) {
                            ...
                            Error_Msg = "LM_Policy_node_missing";
                        }
                        ...
                        if (objResponseJson['Root'].hasOwnProperty('Receipt')) {
                            ...
                            Error_Msg = "LM_Receipt_node_missing";
                        }
                        ...
                        if (objResponseJson['Root'].hasOwnProperty('Client')) {
                            ...
                            Error_Msg = "LM_Client_node_missing";
                        }
                    }
                }
            } catch (e) {
