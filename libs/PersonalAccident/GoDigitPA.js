...
util.inherits(GoDigitPA, PA);

GoDigitPA.prototype.lm_request_single = {};
GoDigitPA.prototype.insurer_integration = {};
GoDigitPA.prototype.const_insurer_suminsured = [500000,1000000, 1500000, 2000000, 2500000, 5000000, 7500000, 10000000, 15000000, 20000000];
GoDigitPA.prototype.insurer_addon_list = [];
GoDigitPA.prototype.insurer = {};
GoDigitPA.prototype.insurer_date_format = 'DD-MMM-YYYY';


GoDigitPA.prototype.insurer_product_api_pre = function (objProduct, Insurer_Object, specific_insurer_object) {
    console.log('insurer_product_api_pre');
};
GoDigitPA.prototype.insurer_product_field_process_pre = function () {
    var member = 1;
...
GoDigitPA.prototype.insurer_product_response_handler = function (objResponseJson, objProduct, Insurer_Object, specific_insurer_object) {
...
GoDigitPA.prototype.insurer_product_field_process_post = function () {

};
GoDigitPA.prototype.insurer_product_api_post = function () {

};
GoDigitPA.prototype.service_call = function (docLog, objProduct, Insurer_Object, specific_insurer_object, Db_Idv_Item) {
    ...
    try {
        ...
        var tokenUrl = "https://preprod-oneapi.godigit.com/OneAPI/digit/generateAuthKey";
        var args1 = {
            "username": "35327650",
            "password": "Digit@123$"
        };
         client.post(tokenUrl, args1, function (data, response) {
             console.log(data);
            ...
            var args = {
                ...
                headers: {
                    ...
                    "integrationId": specific_insurer_object.method.Method_Type === 'Premium'?"21298-0100":"21300-0100"
                }
            };
...
GoDigitPA.prototype.premium_response_handler = function (objResponseJson) {
...
GoDigitPA.prototype.proposal_response_handler = function (objResponseJson) {
...
GoDigitPA.prototype.pg_response_handler = function () {
    try {
...
GoDigitPA.prototype.verification_response_handler = function (objResponseJson) {
...
GoDigitPA.prototype.pdf_call = function (url, args, pdf_sys_loc) {
    var objInsurerProduct = this;
...
GoDigitPA.prototype.pdf_response_handler = function (objResponseJson) {
...
GoDigitPA.prototype.get_plan_si = function (plan_name) {
   
//    var index = plans.findIndex(x => x.Plan_Name === plan_name);
//    return index === -1 ? "" : plans[index]['SI'];
};
GoDigitPA.prototype.get_plan_area = function (plan_id) {
    if(plan_id === 100){
...
GoDigitPA.prototype.calculate_bmi = function (i) {
...
GoDigitPA.prototype.is_valid_plan = function (lm_request, planCode) {
    console.log('GoDigitPA is_valid_plan', 'start');
    if(lm_request.member_count>1){
        return false;
    }
//    else if(lm_request.pa_insurance_si<1000000 && lm_request.initial_si){
//        return false;
//    }
    else{
    return true;
...
GoDigitPA.prototype.get_member_relation = function (i) {
...
GoDigitPA.prototype.premium_breakup_schema = {
    "net_premium": "premium",
    "CGST": "CGST",
    "SGST": "SGST",
