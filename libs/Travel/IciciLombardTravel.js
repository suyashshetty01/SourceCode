...
IciciLombardTravel.prototype.insurer_product_field_process_pre = function () {
    ...
    if (this.lm_request['method_type'] === 'Premium') {
        ...
        this.getSI(this.prepared_request['Plan_Id'], this.prepared_request['Plan_Name']);
        ...
        this.processed_request['___policy_type___'] = this.lm_request['travel_insurance_type'] === "floater" ? "Family Floater" : "Individual";
...
IciciLombardTravel.prototype.getSI = function (planId, planName) {
    if (planName.includes("500")) {
        this.prepared_request['travel_insurance_si_' + planId] = "$500000";
    } else if (planName.includes("250")) {
        this.prepared_request['travel_insurance_si_' + planId] = "$250000";
    } else if (planName.includes("100")) {
        this.prepared_request['travel_insurance_si_' + planId] = "$100000";
    } else if (planName.includes("25")) {
        this.prepared_request['travel_insurance_si_' + planId] = "$25000";
    } else {
        this.prepared_request['travel_insurance_si_' + planId] = "$50000";
    }
};
