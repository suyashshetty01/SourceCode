    ...
    $('.Heading1').click(function (e) {
        ...
        if ($('#FinalSubmit').val() == "1" && ($(this).attr('id') == 'PaymentLink' || $(this).attr('id') == 'RequestForInspection' || $(this).attr('id') == 'PayAgent')) {
            ...
            if ($('#ReasonforCPAChola').val() !== "0" && summary.Summary.Insurer_Id === 3) {
                request["ReasonforCPAOpt"] = "";
                request["DateforCPAOpt"] = "";
                if ($('#ReasonforCPAChola').val() !== "" && $('#ReasonforCPAChola').val() !== "0") {
                    request["ReasonforCPAOpt"] = $('#ReasonforCPAChola').val();
                }
                if ($('#DORofCPA').val() !== "") {
                    request["DateforCPAOpt"] = $('#DORofCPA').val();
                }
            }
...
function update_user_data(current_div) {
    ...
    if ($('#ReasonforCPAChola').val() !== "0" && summary.Summary.Insurer_Id === 3) {
        ...
        obj["DateforCPAOpt"] = "";
        if ($('#ReasonforCPAChola').val() !== "" && $('#ReasonforCPAChola').val() !== "0") {
            obj["ReasonforCPAOpt"] = $('#ReasonforCPAChola').val();
        }
        if ($('#DORofCPA').val() !== "") {
            obj["DateforCPAOpt"] = $('#DORofCPA').val();
        }
    }
...
function set_values(request) {
    ...
    if (request.hasOwnProperty("ReasonforCPAOpt"))
    { $('#ReasonforCPAChola').val(request["ReasonforCPAOpt"]); }
    if (request.hasOwnProperty("DateforCPAOpt"))
    { $('#DORofCPA').val(request["DateforCPAOpt"]); 
        if (request["ReasonforCPAOpt"] == "Stand-alone CPA" || request["ReasonforCPAOpt"] == "General Personal Accident cover") { $("#divDORofCPA").show(); } else { $("#divDORofCPA").hide(); }
    }
    //pucc
