...
Base.prototype.master_db_get = function (objProduct, Insurer_Object, specific_insurer_object) {
    try {
        ...
        if ([12, 10, 1].includes(objProduct.lm_request.product_id)) {
        ...
        if (tp_ins_flag) {
            ...
            console.log('Continue for non motor products');
        }
...
Base.prototype.pg_ack_url = function (insurer_id = 0) {
    ...
    if (config.environment.name === 'Production') {
        ...
        if (insurer_id === 10) {
            ...
            pg_ack_url = 'http://localhost:7000' + '/transaction-status/' + this.lm_request['udid'] + '/' + this.lm_request['crn'] + '/' + this.lm_request['proposal_id'];
        }
        //pg_ack_url = 'http://horizon.policyboss.com/transaction-status/' + this.lm_request['udid'] + '/' + this.lm_request['crn'] + '/' + this.lm_request['proposal_id'];
    }
    return pg_ack_url;
...
Base.prototype.proposal_confirm_url = function (insurer_id = 0, proposal_id) {
    ...
    if (config.environment.name === 'Production') {
        ...
        t_proposal_confirm_url = 'http://localhost:7000' + '/proposal-confirm?udid=' + this.lm_request['udid'] + '&proposal_id=' + this.lm_request['proposal_id'];
    }
