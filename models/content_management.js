...
var content_management_Schema = new Schema({
    ...
    "Version": Number,
	"Type": String,
    "Category": String,//{type: String, enum: ["CMS", "BLOG"]},
    "Author": String,
    "Source": String,
    "Blog_Date": Date,
    "Image": String,
    "Blog_Title": String,
    "Is_Spotlight":{type: String, default:""},
    "Spotlight_Image": {type: String, default:""}
});

// the schema is useless so far
// we need to create a model using it
content_management_Schema.plugin(mongoosePaginate);
content_management_Schema.plugin(autoIncrement.plugin, {model: 'content_management', field: 'Content_Id', startAt: 824});
