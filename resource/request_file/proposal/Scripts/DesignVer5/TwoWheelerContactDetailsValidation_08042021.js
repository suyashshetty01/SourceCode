...
function ValidateCD(InsName) {
    ...
    if (VehicleRegistrationType == "individual") {
        ...
        if (SalutationVal.toUpperCase() == "MR") {
        ...
        } else if (SalutationVal.toUpperCase() == "MRS" || SalutationVal.toUpperCase() == "MS") {
            if (displayGenderBlock != "none") {
                if (GenderVal == "M") {
                    $('#Salutation').addClass('Error');
                    ValidationArray.push('Salutation');
            ...
            if (MaritalStatus == "U" || MaritalStatus == "S" || MaritalStatus == "SINGLE" || MaritalStatus == "UnMarried" || MaritalStatus == "Divorced" || MaritalStatus == "Widowed"){
                {
...
function ValidateVAD(InsName) {
    ...
    if (is_valid_pucc && is_valid_pucc == "yes" && summary.Quote_Request.vehicle_insurance_type === "renew") {
        if ($("#PUCC_No_Yes").hasClass('btn-default') && $("#PUCC_valid_yn").val() == "no" && (InsurerID == 4 || InsurerID == 10 || InsurerID == 19 )) {
        ...
        if (is_valid_pucc == undefined) {
            ...
            if (summary.Quote_Request.vehicle_insurance_type === "renew" && is_valid_pucc) {
                if (summary.Quote_Request.vehicle_insurance_type === "renew" && is_valid_pucc && is_valid_pucc == "no" && (InsurerID == 4 || InsurerID == 10)) {
                    $('#dvIsPucc').addClass('Error'); ValidationArray.push('PUCC_valid_yn'); ValidateError++;
                } else {
                    $('#dvIsPucc').removeClass('Error');
                }
...
function set_values(request) {
    ...
    if (request.hasOwnProperty("is_valid_pucc")) {
        if (request.insurer_id == 4 || request.insurer_id == 10) {
