...
$("#RegisteredCityName").autocomplete({
    source: function (request, response) {
        ...
        var count = 0;
        append_data = data1.filter(function (name) {
    ...
    select: function (event, ui) {
        ...
        $('#RegisteredCityId').val(ui.item.city_code);
        $('#RegisteredStateId').val(ui.item.state_code);
...
$("#ContactCityName").autocomplete({
    ...
    select: function (event, ui) {
        ...
        $('#ContactCityID').val(ui.item.city_code);
        $('#CommunicationStateId').val(ui.item.state_code);
