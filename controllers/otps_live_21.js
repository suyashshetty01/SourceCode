                        ...
                        if (err) {
                           ...
                           /*
                            if (insurer_id === 33) {
                                ...
                                Msg = "Please validate Motor proposal no: " + crn + " by entering OTP: " + OTP_Data + ", valid for 30 minutes. Make&Model: " + make_model + " Renewal NCB: " + renewal_ncb + " Reg. year: " + reg_year + " Break in: " + breakin + " Premium: " + final_premium + ". Landmark Insurance Brokers (PolicyBoss.com)";
                            } else {
                                let objReplace = {
                                    '___otp___': OTP_Data,
                                    '___product___': Product
                                };
                                Msg = objSmsLog.otp_quote(objReplace);
                            }  */
                            let objReplace = {
                                '___otp___': OTP_Data,
                                '___product___': Product
