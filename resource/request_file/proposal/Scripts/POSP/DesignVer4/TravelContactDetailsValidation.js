$(document).ready(function () {
    ...
    $("#dvContactDOB").click(function ()
    {
        $("#ContactDOB").datepicker("show");
        if ($('#ContactDOB').val() != "") { $('#dvContactDOB').removeClass('Error'); }
    });
    ...
    $("#dvpassportExpiry").click(function () { $("#passportExpiry").datepicker("show"); if ($('#passportExpiry').val() != "") { $('#dvpassportExpiry').removeClass('Error'); } });
