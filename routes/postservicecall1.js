...
router.post('/onboarding/profile_update_posp_user', function (req, res) {
        try {
            let posp_user = require('../models/posp_users.js');
...
//router.get('/posp-page/insurer/:type',(req,res)=>{
//    try{
//        var insurerType=req.params.type;
//        var args={"Insurer_Type": insurerType}
//        
//        insurer.find(args).select('Insurer_Code Insurer_ID').exec()
//        .then(insurers => {
//            res.json({"Status":"Success","Data":insurers}); 
//        })
//        .catch(error => {
//            console.error('Error:', error);
