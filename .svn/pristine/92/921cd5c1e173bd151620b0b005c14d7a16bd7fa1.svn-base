...
IciciLombardMarine.prototype.insurer_product_field_process_pre = function () {
    ...
    this.prepared_request['mode_of_transit'] = this.lm_request['mode_of_transit'];
    ...
    if (this.lm_request['method_type'] === 'Premium') {
        ...
        var description_Of_Cargo = (this.lm_request['description_Of_Cargo'] ? this.lm_request['description_Of_Cargo'] : "new cargo");
        this.prepared_request['description_Of_Cargo'] = description_Of_Cargo;
        this.processed_request['___description_Of_Cargo___'] = this.prepared_request['description_Of_Cargo'];
...
//        this.processed_request['___city_code___'] = this.prepared_request['city_id'];
        ...
        var returnUrl = "";
        var returnUrl = ((config.environment.name === 'Production') ? 'http://horizon.policyboss.com/transaction-status/' : 'http://qa-horizon.policyboss.com/transaction-status/') + this.lm_request['udid'] + '/' + this.lm_request['crn'] + '/' + this.lm_request['proposal_id'];
        ;
...
IciciLombardMarine.prototype.customer_response_handler = function (objResponseJson) {
    ...
    try {
        ...
        if (Error_Msg === 'NO_ERR') {
            if (objResponseJson['proposalNumber'] !== null || objResponseJson['customerId'] !== null) {
                var Customer = {
