...
function ValidateVAD(InsName) {
    ...
    else if (InsName == "Kotak") {
        if (summary.Quote_Request.vehicle_insurance_type === "new" && ($ChasisNumber.val() == "" || ($ChasisNumber.val().length < 8 || $ChasisNumber.val().length > 17) || pattern.test($ChasisNumber.val()) == false || checkText($('#ChasisNumber')) == true)) {
            $('#dvChasisNumber').addClass('Error'); ValidationArray.push('ChasisNumber'); ValidateError++;
        }
        else if (summary.Quote_Request.vehicle_insurance_type === "renew" && ($ChasisNumber.val() == "" || $ChasisNumber.val().length !== 17 || pattern.test($ChasisNumber.val()) == false || checkText($('#ChasisNumber')) == true)) {
            $('#dvChasisNumber').addClass('Error'); ValidationArray.push('ChasisNumber'); ValidateError++;
        }
        else {
            $('#dvChasisNumber').removeClass('Error');
    ...
    if (true) {
        ...
        if ($(".btn_yes").hasClass('active_Btn')) {
            if ($("#whatsappMblNo").val().length == 0 || checkMobile($('#whatsappMblNo')) == false) {
                $('#errwhatsappMblNo').text("Please Enter valid number").addClass('Errorchack');
                ValidateError++;
                return false;
