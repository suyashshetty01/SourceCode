        ...
        objModelSms.save(function (err, objDbSms) {
            ...
            var args = {
                data: {
                    ...
                    'sender': (source === 'PB') ? 'POLBOS' : 'RPBOSS',
...
Sms_Log.prototype.leadPurchase = function (objReplace) {
    var contentSms_Log = "POLBOS-SYNC_PURCHASE\n\
-------------------------------\n\
Customer has purchase lead successfully.\n\
\n\
Agent: ___agent_name___(Mob: ___agent_mobile___ )\n\
Lead Count: ___lead_count___\n\
Amount: ___amount___ INR\n\
SubmittedOn: ___current_dt___";

    contentSms_Log = contentSms_Log.replaceJson(objReplace);
    return contentSms_Log;
};
Sms_Log.prototype.protect_me_well = function (objReplace) {
    var contentSms_Log = "POLBOS-PROTECT-ME-WELL\n\
-------------------------------\n\
Customer has successfully Submited Protect Me Well Data.\n\
\n\
Customer Name: ___customer_name___\n\
Mobile: ___customer_mobile___\n\
Link: ___protect_me_well_link___ INR\n\
SubmittedOn: ___current_dt___";
